...
<input type = "submit" name ="logout" value="LogOut" style="float:right;style.display='block';width:auto;background-color:green;border:10px solid green;color:white;">
