...
import com.wise.olx.dao.CategoryDAO;
import com.wise.olx.dao.ItemDAO;
import com.wise.olx.dao.ModeratorDAO;
import com.wise.olx.dao.SubCategoryDAO;
import com.wise.olx.dao.UserDAO;
import com.wise.olx.dto.Category;
import com.wise.olx.dto.Item;
import com.wise.olx.dto.Moderator;
import com.wise.olx.dto.SubCategory;
import com.wise.olx.dto.User;
import com.wise.olx.util.DBUtility;
...
public class OLXController extends HttpServlet {
	...
	private RequestDispatcher registerAsUser(HttpServletRequest request) {
		...
		return request.getRequestDispatcher("./welcome.jsp");
	}
	private RequestDispatcher loginAsUser(HttpServletRequest request) {
		...
		if((email != null) && (pwd != null) && (user.getPassword().equals(pwd)))	{
			...
			return request.getRequestDispatcher("./user.jsp");
		}
		else	{
